...
var DiceCup;
(function (DiceCup) {
    function getGameModeTranslation(_gamemode) {
        switch (_gamemode) {
    ...
    DiceCup.getGameModeTranslation = getGameModeTranslation;
})(DiceCup || (DiceCup = {}));
var DiceCup;
(function (DiceCup) {
...
(function (DiceCup) {
    ...
    async function getRooms(_message) {
        ...
        for (let i = _message.content.rooms.length - 1; i > 0; i--) {
            ...
            gamemode.innerHTML = DiceCup.getGameModeTranslation(_message.content.gamemode[i]);
            gamemodeContainer.appendChild(gamemode);
            let locked = document.createElement("img");
...
(function (DiceCup) {
    ...
    async function setGameSettings(message) {
        DiceCup.roundTimer = parseInt(message.content.roundTimer);
        DiceCup.gameSettings_mp = { playerNames: ["", "", "", "", "", ""] };
